...
const SignUpPage = () => {
  ...
  `;
  const userIconUrl = `data:image/svg+xml;utf8,${encodeURIComponent(userIconSvg.replace(/currentColor/g, '#6b7280'))}`;
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="form-control">
              ...
              <input
                ...
                placeholder="Sadie Sink"
                value={formData.fullName}
                onChange={(e) => setFormData({ ...formData, fullName: e.target.value })}
                style={inputWithUserIconStyle}
              />
            </div>
